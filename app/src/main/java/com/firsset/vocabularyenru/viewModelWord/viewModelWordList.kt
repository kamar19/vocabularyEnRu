package com.firsset.vocabularyenru.viewModelWord
...
@KoinApiExtension
class ViewModelWordList(
    private val repository: WordRepository, val repositoryDB: RepositoryDB,
    ...
    suspend fun loadAndSaveStartMovieFromNET(seachMovie: SeachMovie): List<Movie> {
        ...
        moviesFromNet =
            repository.loadMoviesFromNET(seachMovie.seachMovie).sortedBy { it.ratings }
        moviesFromNet.let {
